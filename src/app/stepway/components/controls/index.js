...
import { NumberInputConfig } from './numberInput/config/numberInput.config';
import editNumberInputModule, { editNumberInputControlComponent, EDIT_NUMBERINPUT_COMPONENT } from './numberInput/editNumberInput/editNumberInput.component';

// import { MultiSelectConfig } from './multiSelect/config/multiSelect.config';
// import editMultiSelectModule, { editMultiSelectControlComponent, EDIT_MULTI_SELECT_COMPONENT } from './multiSelect/editMultiSelect/editMultiSelect.component';

import { DateTimeConfig } from './DateTime/config/datetime.config';
import editDateTimeModule, { editDateTimeControlComponent, EDIT_DATE_TIME_COMPONENT } from './DateTime/editDateTime/editDateTime.component';

import { RepeatSectionConfig } from './repeatGroup/config/repeatGroup.config';
import editRepeatSectionModule, { editRepeatSectionControlComponent, EDIT_REPEAT_SECTION_CONTROL_COMPONENT } from './repeatGroup/editRepeatGroup/editRepeatGroup.component';
...
const controls = [
    ...
    // editNumber:
    {
        name: EDIT_NUMBERINPUT_COMPONENT,
        component: editNumberInputControlComponent,
        moduleName: editNumberInputModule.name
    },
    // // editMultiSelect:
    // {
    //     name: EDIT_MULTI_SELECT_COMPONENT,
    //     component: editMultiSelectControlComponent,
    //     moduleName: editMultiSelectModule.name
    // },
    // editDateTime:
    {
        name: EDIT_DATE_TIME_COMPONENT,
        component: editDateTimeControlComponent,
        moduleName: editDateTimeModule.name
    },
    // editRepeatSection:
    {
        name: EDIT_REPEAT_SECTION_CONTROL_COMPONENT,
        component: editRepeatSectionControlComponent,
        moduleName: editRepeatSectionModule.name
    },
    // editDate:
    {
